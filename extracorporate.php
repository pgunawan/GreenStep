	...
	<form method = "POST" id = "corporate-form" class = "clearfix">
		<div class = "half left">
			...
			<div class="bs-example-tooltips">
				<button class="popper" data-toggle="popover"><span class="glyphicon glyphicon-question-sign"></span></button>
...
<div class="bs-example-tooltips">
	...
	<div class="popper-content hide">
		...
		<h4>GHG Champion</h4>
		<div style="border-top: solid 8px #5CB357"> </div>
		<p style="color: black">Enter the contact information for the individual who leads your company's GHG reduction commitment.</p>
	</div>
</div>
...
<div class="bs-example-tooltips">
	...
	<div class="popper-content hide">
		...
		<div style="border-top: solid 8px #5CB357"> </div>
		<p style="color: black">Enter the contact information for the individual who manages your GHG accounting activities. This is the person who oversees data entry and sses to it that the emissions 
			data is of highest quality.</p>
		</div>
	</div>
...
<div class="bs-example-tooltips">
	...
	<div class="popper-content hide">
		...
		<h4>Reporting Year<h4>
			<div style="border-top: solid 8px #5CB357"> </div>
			<p style="color: black">Enter the year-end date for the purpose of tracking your corporate greenhouse gases. For example, enter December 31 if you wish to track emissions by calendar year. 
				Or, enter your fiscal yearend date if you wish to track emissions by fiscal year.</p>
			</div>
		</div>
